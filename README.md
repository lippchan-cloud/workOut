...
## 核心功能：
1. 登录 / 注册：用户名 + 密码，JWT；绑定邮箱后可用 4 位验证码登录。未登录可见导航壳，顶栏提示登录；点 Tab 或业务操作跳转登录。
...
7. 我的：身体资料 / 账号安全 / 报告记录 / 退出登录；账号操作二次确认；身体资料含真实日期，页下方是成长曲线；可绑定邮箱。公开报告页 `/report/:id` 不走三 Tab，可回首页。顶栏右上角显示账号或「登录」。
